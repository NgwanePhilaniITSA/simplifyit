...
// A reusable Update Button component
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      ...
      icon: const Icon(Icons.edit,
          color: Colors.white), // Icon to display (Edit icon for update)
      label: Text(
        label ?? '', // Default text is 'Update' if no label is provided
        style: const TextStyle(color: Colors.white),
      ),
      style: ElevatedButton.styleFrom(
        backgroundColor: Colors.orange, // Orange background color for update
